...
<head>
	...
	<meta name="keywords" content="Viagens,Agencia de viagens,CFTUR,Viagens em fortaleza,Fortaleza"/>
	<meta name="description" content="Pagina de agencia de viagens cftur"/>
	<meta name="author" content="Carlos Jonas"/>

	<!--FAVICON-->
	<link rel="sortcut icon" href="#" type="image/ico" />
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
					    	<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						        <li class="nav-item">
						          <a class="nav-link active" aria-current="page" href="pacotes.php">Pacotes</a>
						        </li>
						        <li class="nav-item">
